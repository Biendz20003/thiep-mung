(function () {
    ...
    function drawFlowers() {
      ...
      "crosshatch":{h:1,s:91,l:46,vary:80,mix:true},
      ...
      let colors =  getThemeColors(colorOpt) 
      ...
      for(let i=0; i<numFlower; i++){
        if(mode=="multi") {
          pistilC = new randomColor(50).hsl()
          petalC = new randomColor(50).hsl()
          pistilC2 = new randomColor(50).hsl()
          petalC2 = new randomColor(50).hsl()
        }
        drawFlower(opt)
      }
    } 
    ...
    function Flower(opt) {
      ...
      this.petalBase = getRandomInt(0,5);
  ...
  function distance(p1, p2) {
    return Math.floor(Math.sqrt(Math.pow(p1.x-p2.x,2) + Math.pow(p2.y - p1.y,2)))      
  }
